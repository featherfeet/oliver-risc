...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/sdram_system_cmd_xbar_demux.sv"                       -work cmd_xbar_demux                                                              
  ...
  vlog  "$QSYS_SIMDIR/submodules/sdram_system_id_router.sv"                            -work id_router                                                                   
  vlog  "$QSYS_SIMDIR/submodules/sdram_system_addr_router.sv"                          -work addr_router                                                                 
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                        -work bridge_0_avalon_master_translator_avalon_universal_master_0_agent           
